...
assert.equal(
  context.getOfferId({ offer_id: '4294581', idoferta: '4294581', iddetalle: '4278473' }),
  'D_4278473',
  'LIVE_OFFER_IDENTITY_V1: caller cannot override detail identity by omitting source_offer_key'
);
